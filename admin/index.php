...
$query = "SELECT * FROM posts WHERE post_statuts = 'published' ";
$select_all_published_posts = mysqli_query($connection,$query);
$post_published_counts = mysqli_num_rows($select_all_published_posts);

$query = "SELECT * FROM posts WHERE post_statuts = 'draft' ";
$select_all_draft_posts = mysqli_query($connection,$query);
$post_draft_counts = mysqli_num_rows($select_all_draft_posts);

$query = "SELECT * FROM comments WHERE comment_statuts = 'unapproved' ";
...
<script type="text/javascript">
   ...
   $element_count = [$post_counts,$post_published_counts,$post_draft_counts, $comment_count,$unapproved_comment_counts, $user_count,$subscriber_count, $cat_count ];
